...
export default function ManagerCapaDetailPage() {
	...
	if (error || !report) return (
		<div className="max-w-2xl mx-auto py-20 text-center">
			...
			<Link href="/dashboard/manager/capa" className="text-blue-600 font-bold hover:underline">Go back to list</Link>
		</div>
	);
	...
	return (
		<div className="max-w-4xl mx-auto pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
			...
			<div className="mb-8 flex items-center gap-3">
				<Link href="/dashboard/manager/capa" className="text-slate-400 hover:text-slate-900 transition-colors text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
